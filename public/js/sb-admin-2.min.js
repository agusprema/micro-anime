...
$(document).ready(function(){
    ...
    function sweat_success_list(){Swal.fire({position:"center",type:"success",title:"Your list has been saved",showConfirmButton:!1,timer:1500})}function sweat_error_list(){Swal.fire({position:"center",type:"error",title:"Oops...",text:"Something went wrong!",showConfirmButton:!1,timer:1500})}var countChecked=function(){1==$("#customSwitch1:checked").length?($(".btn-close").removeClass("d-none"),$(".box-post").addClass("mbs-10"),$(".baba").addClass("mbs-40")):($(".btn-close").addClass("d-none"),$(".box-post").removeClass("mbs-10"),$(".baba").removeClass("mbs-40"))};countChecked(),$("#customSwitch1").on("click",countChecked),$(document).on("click",".btn-close",function(e){e.preventDefault();var t=$(this).data("anim");$(this),Swal.fire({title:"Are you sure?",text:"You won't be able to revert this!",type:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Yes, delete it!"}).then(e=>{e.value&&($.getJSON(base_url+"api/check_login/",function(e){"true"==e.login?$.ajax({url:base_url+"api/remove_user_to_list/"+t,type:"GET",success:function(e){"success"==e?($("."+t).addClass("d-none"),sweat_success_list()):sweat_error_list()}}):window.location.href = base_url}),Swal.fire("Deleted!","Your file has been deleted.","success"))})});
