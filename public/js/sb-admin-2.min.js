...
$(document).ready(function(){
    ...
    var countChecked = function() {
        1 == $("#customSwitch1:checked").length ? ($(".btn-close").removeClass("d-none"), $(".box-post").addClass("mbs-10"), $(".container-bookmmark-anime").addClass("mb-4")) : ($(".btn-close").addClass("d-none"), $(".box-post").removeClass("mbs-10"), $(".container-bookmmark-anime").removeClass("mb-4"))
    };
    countChecked(), $("#customSwitch1").on("click", countChecked)
        ...
        $(this), Swal.fire({
            ...
            e.value && ($.getJSON(base_url + "api/check_login/", function(e) {
                "true" == e.login ? $.ajax({
                    ...
                    type: "GET",
                    success: function(e) {
                        "false" == e.error ? ($("." + t).addClass("d-none")) : sweat_error_list()
                    }
                }) : window.location.href = base_url
            }))
            Swal.fire("Deleted!", "Your Bookmarks has been deleted.", "success")
        })
    });
    ...
    $('#tolltip').tooltip({ boundary: 'window' });
    ...
    console.log(panjang);
    if(panjang < 800){$('#page-top').addClass('sidebar-toggled');$('#accordionSidebar').addClass('toggled');}
