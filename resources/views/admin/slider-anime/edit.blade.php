...
@section('title', 'Edit Slider Anime Management')
...
<div class="row">
    <div class="col-lg">
        ...
        <form action="{{ url('/admin/slider-anime', $slider->id) }}" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_anime" name="id_anime" value="{{ $slider->id_anime ?? old('id_anime') }}">
                    @error('id_anime')
