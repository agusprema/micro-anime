...
<div class="col-md-2-a p-1 box-post float-left">
    <a href="{{ route('anime.details', ['anime' => $genre->id_anime]) }}" title="{{ $genre->title_anime }}">
    ...
    <div class="label-episode-right text-white">Episode {{ \DB::table('episode_animes')->where('id_anime', $genre->id_anime)->count() }}</div>
