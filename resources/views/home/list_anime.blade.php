...
<div class="id-list-anime mb-2" id="#">
    ...
    @foreach ($sd as $sd)
    <a class="float-left text-primary" title="{{ $sd->title_anime }}" href="{{ url('/anime') . '/' . $sd->id_anime }}">{{ $sd->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="A">
    ...
    @foreach ($as as $a)
    <a class="float-left text-primary" title="{{ $a->title_anime }}" href="{{ url('/anime') . '/' . $a->id_anime }}">{{ $a->title_anime }}</a>
    @endforeach
    <div class="clearfix"></div>
</div>
...
<div class="id-list-anime mb-2" id="B">
    ...
    @foreach ($bs as $b)
    <a class="float-left text-primary" title="{{ $b->title_anime }}" href="{{ url('/anime') . '/' . $b->id_anime }}">{{ $b->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="C">
    ...
    @foreach ($cs as $c)
    <a class="float-left text-primary" title="{{ $c->title_anime }}" href="{{ url('/anime') . '/' . $c->id_anime }}">{{ $c->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="D">
    ...
    @foreach ($ds as $d)
    <a class="float-left text-primary" title="{{ $d->title_anime }}" href="{{ url('/anime') . '/' . $d->id_anime }}">{{ $d->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="E">
    ...
    @foreach ($es as $e)
    <a class="float-left text-primary" title="{{ $e->title_anime }}" href="{{ url('/anime') . '/' . $e->id_anime }}">{{ $e->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="F">
    ...
    @foreach ($fs as $f)
    <a class="float-left text-primary" title="{{ $f->title_anime }}" href="{{ url('/anime') . '/' . $f->id_anime }}">{{ $f->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="G">
    ...
    @foreach ($gs as $g)
    <a class="float-left text-primary" title="{{ $g->title_anime }}" href="{{ url('/anime') . '/' . $g->id_anime }}">{{ $g->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="H">
    ...
    @foreach ($hs as $h)
    <a class="float-left text-primary" title="{{ $h->title_anime }}" href="{{ url('/anime') . '/' . $h->id_anime }}">{{ $h->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="I">
    ...
    @foreach ($is as $i)
    <a class="float-left text-primary" title="{{ $i->title_anime }}" href="{{ url('/anime') . '/' . $i->id_anime }}">{{ $i->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="J">
    ...
    @foreach ($js as $j)
    <a class="float-left text-primary" title="{{ $j->title_anime }}" href="{{ url('/anime') . '/' . $j->id_anime }}">{{ $j->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="K">
    ...
    @foreach ($ks as $k)
    <a class="float-left text-primary" title="{{ $k->title_anime }}" href="{{ url('/anime') . '/' . $k->id_anime }}">{{ $k->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="L">
    ...
    @foreach ($ls as $l)
    <a class="float-left text-primary" title="{{ $l->title_anime }}" href="{{ url('/anime') . '/' . $l->id_anime }}">{{ $l->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="M">
    ...
    @foreach ($ms as $m)
    <a class="float-left text-primary" title="{{ $m->title_anime }}" href="{{ url('/anime') . '/' . $m->id_anime }}">{{ $m->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="N">
    ...
    @foreach ($ns as $n)
    <a class="float-left text-primary" title="{{ $n->title_anime }}" href="{{ url('/anime') . '/' . $n->id_anime }}">{{ $n->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="O">
    ...
    @foreach ($os as $o)
    <a class="float-left text-primary" title="{{ $o->title_anime }}" href="{{ url('/anime') . '/' . $o->id_anime }}">{{ $o->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="P">
    ...
    @foreach ($ps as $p)
    <a class="float-left text-primary" title="{{ $p->title_anime }}" href="{{ url('/anime') . '/' . $p->id_anime }}">{{ $p->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="Q">
    ...
    @foreach ($qs as $q)
    <a class="float-left text-primary" title="{{ $q->title_anime }}" href="{{ url('/anime') . '/' . $q->id_anime }}">{{ $q->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="R">
    ...
    @foreach ($rs as $r)
    <a class="float-left text-primary" title="{{ $r->title_anime }}" href="{{ url('/anime') . '/' . $r->id_anime }}">{{ $r->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="S">
    ...
    @foreach ($ss as $s)
    <a class="float-left text-primary" title="{{ $s->title_anime }}" href="{{ url('/anime') . '/' . $s->id_anime }}">{{ $s->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="T">
    ...
    @foreach ($ts as $t)
    <a class="float-left text-primary" title="{{ $t->title_anime }}" href="{{ url('/anime') . '/' . $t->id_anime }}">{{ $t->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="U">
    ...
    @foreach ($us as $u)
    <a class="float-left text-primary" title="{{ $u->title_anime }}" href="{{ url('/anime') . '/' . $u->id_anime }}">{{ $u->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="V">
    ...
    @foreach ($vs as $v)
    <a class="float-left text-primary" title="{{ $v->title_anime }}" href="{{ url('/anime') . '/' . $v->id_anime }}">{{ $v->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="W">
    ...
    @foreach ($ws as $w)
    <a class="float-left text-primary" title="{{ $w->title_anime }}" href="{{ url('/anime') . '/' . $w->id_anime }}">{{ $w->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="X">
    ...
    @foreach ($xs as $x)
    <a class="float-left text-primary" title="{{ $x->title_anime }}" href="{{ url('/anime') . '/' . $x->id_anime }}">{{ $x->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="Y">
    ...
    @foreach ($ys as $y)
    <a class="float-left text-primary" title="{{ $y->title_anime }}" href="{{ url('/anime') . '/' . $y->id_anime }}">{{ $y->title_anime }}</a>
    @endforeach
...
<div class="id-list-anime mb-2" id="Z">
    ...
    @foreach ($zs as $z)
    <a class="float-left text-primary" title="{{ $z->title_anime }}" href="{{ url('/anime') . '/' . $z->id_anime }}">{{ $z->title_anime }}</a>
    @endforeach
